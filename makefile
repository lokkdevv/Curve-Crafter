...
engine = ./src/core/engine/engine.c
...
win: ${main} ${math} ${engine} ${win_input} ${win_renderer}
	${CC}  ${CFLAGS}  ${main} ${math} ${engine} ${win_input} ${win_renderer}  -o ${out}

linux: ${main} ${math} ${engine} ${unix_input} ${unix_renderer}
	${CC}  ${CFLAGS}  ${main} ${math} ${engine} ${unix_input} ${unix_renderer}  -o ${out}
